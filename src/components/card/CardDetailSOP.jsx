...
const CardDetailSOP = ({ title, link }) => {
  ...
  return (
    <div className=" w-max md:w-auto md:flex-col md:justify-center md:items-center lg:flex-row  p-2 rounded-md box card card-side hover:border-[#cf2300] hover:border-[3px] cursor-pointer bg-base-100">
